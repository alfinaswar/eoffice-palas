                        ...
                        <form action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nik" class="form-control" id="nik" placeholder="No. KTP / SIM / Pasport" value="{{ old('nik') }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="kelurahan" id="desa" disabled>
                                        <option value="">==Pilih Salah Satu==</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12" hidden>
                                    <label for="roles" class="form-label"><strong>Peran Customer</strong></label>
                                    <select name="roles[]" id="roles" class="form-select" multiple readonly>
                                        @foreach ($roles as $key => $role)
                                            @if(str_contains(strtolower($role), 'Customer'))
                                                <option value="{{ $key }}"
