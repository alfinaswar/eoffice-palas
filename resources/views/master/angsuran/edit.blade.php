        ...
        <div class="row">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Angsuran</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0">Form Edit Angsuran</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('master-angsuran.update', $angsuran->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" name="JumlahPembayaran"
                                    ...
                                    value="{{ old('JumlahPembayaran', $angsuran->JumlahPembayaran) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="KonversiTahun"
                                    ...
                                    value="{{ old('KonversiTahun', $angsuran->KonversiTahun) }}" readonly>
                                @error('KonversiTahun')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
