        ...
        <div class="row">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('master-jenis-produk.index') }}">Master Jenis Produk</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0">Formulir Tambah Jenis Produk</h4>
                    <p class="card-text mb-0">
                        Silakan isi data jenis produk baru di bawah ini.
                    </p>
                </div>
                <div class="card-body">
                    <form action="{{ route('master-jenis-produk.store') }}" method="POST">
                        @csrf
                        <div class="row g-3">
