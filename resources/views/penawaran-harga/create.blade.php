        ...
        <div class="col-lg-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-dark text-white">
                    <h4 class="card-title mb-0">Formulir Penawaran Harga</h4>
                    <small class="card-text mb-0">Isi data penawaran dan produk yang ditawarkan.</small>
                </div>
                <div class="card-body">
                    <form action="{{ route('penawaran-harga.store') }}" method="POST">
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="HargaAsli[]"
                                                class="form-control harga-asli-input text-end" value="0" readonly>
                                        </td>
                                        <td>
                        ...
                        <div class="col-12 text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save"></i> Simpan Penawaran
                            </button>
                        </div>
                    </form>
                </div>
