    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form action="{{ route('penawaran-harga.update-approval', encrypt($penawaran->id)) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <h5 class="mb-3 fw-bold text-center">Detail Produk</h5>
                                    ...
                                    @else
                                        @foreach ($penawaran->DetailPenawaran as $d)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input type="hidden" name="Approve[{{ $d->id }}]" value="N">
                                                    <input type="radio" name="ApproveRadio" class="form-check-input approve-baris-radio" value="{{ $d->id }}" title="Checklist untuk approve baris" style="transform: scale(1.5);" {{ $d->Status == 'Y' ? 'checked' : '' }}>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
