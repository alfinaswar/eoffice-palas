                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="Jenis" id="jenis"
                                    ...
                                    @foreach($jenis as $j)
                                        <option value="{{ $j->id }}" {{ old('Jenis') == $j->Nama ? 'selected' : '' }}>
                                            {{ $j->Nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="Grade" id="grade"
                                    ...
                                    @foreach($grade as $g)
                                        <option value="{{ $g->id }}" {{ old('Grade') == $g->Nama ? 'selected' : '' }}>
                                            {{ $g->Nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="Proyek" id="proyek"
                                    ...
                                    @foreach($proyek as $p)
                                        <option value="{{ $p->id }}" {{ old('Proyek') == $p->NamaProyek ? 'selected' : '' }}>
                                            {{ $p->NamaProyek }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" name="Luas"
                                        ...
                                        placeholder="Luas" value="{{ old('Luas') }}" min="0" step="any">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="Diskon" class="form-control @error('Diskon') is-invalid @enderror"
                                    id="diskon" placeholder="Diskon (%)" value="{{ old('Diskon') }}">
                                @error('Diskon')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="HargaNormal"
                                                        ...
                                                        placeholder="Harga Normal" value="{{ old('HargaNormal') }}"
                                                        id="harga_normal">
                                                </div>
                                                @error('HargaNormal')
                                                    <div class="text-danger mt-1">{{ $message }}</div>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="HargaPerMeter"
                                                        ...
                                                        placeholder="Harga Per Meter" value="{{ old('HargaPerMeter') }}"
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="HargaKredit"
                                                        ...
                                                        placeholder="Harga Kredit" value="{{ old('HargaKredit') }}"
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="BesarAngsuran"
                                                        ...
                                                        placeholder="Besar Angsuran" value="{{ old('BesarAngsuran') }}">
                                                </div>
                                                @error('BesarAngsuran')
                                                    <div class="text-danger mt-1">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="HargaDiskon"
                                                        ...
                                                        placeholder="Harga Diskon" value="{{ old('HargaDiskon') }}"
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="HargaPerMeter2"
                                                        ...
                                                        placeholder="Harga Per Meter 2" value="{{ old('HargaPerMeter2') }}"
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="HargaKredit2"
                                                        ...
                                                        placeholder="Harga Kredit 2" value="{{ old('HargaKredit2') }}"
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="BesarAngsuran2"
                                                        ...
                                                        placeholder="Besar Angsuran 2" value="{{ old('BesarAngsuran2') }}">
                                                </div>
