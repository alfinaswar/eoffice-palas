...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col">
                <h3 class="page-title">Edit Progres Pengurusan Tanah</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('pengurusan-tanah.index') }}">Progres Pengurusan Tanah</a>
                    </li>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            {{-- FORM START --}}
            <form action="{{ route('pengurusan-tanah.update', $progresPengurusanSuratTanah->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card shadow-sm">
                    <div class="card-header bg-dark text-white">
                        <h4 class="card-title mb-0">Formulir Edit Progres Pengurusan Tanah</h4>
                        <small>Perbarui data progres pengurusan tanah di bawah ini.</small>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="Deskripsi" id="Deskripsi"
                                    ...
                                    value="{{ old('Deskripsi', $progresPengurusanSuratTanah->Deskripsi) }}">
                                @error('Deskripsi')
                                ...
                                <select name="KodeProyek" id="KodeProyek"
                                    ...
                                    @foreach ($proyeks as $proyek)
                                        <option value="{{ $proyek->id }}"
                                            {{ old('KodeProyek', $progresPengurusanSuratTanah->KodeProyek) == $proyek->id ? 'selected' : '' }}>
                                            {{ $proyek->NamaProyek ?? '' }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="Tanggal" id="Tanggal"
                                    ...
                                    value="{{ old('Tanggal', $progresPengurusanSuratTanah->Tanggal ? \Carbon\Carbon::parse($progresPengurusanSuratTanah->Tanggal)->toDateString() : \Carbon\Carbon::now()->toDateString()) }}">
                                @error('Tanggal')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="Legal" id="Legal"
                                    ...
                                    value="{{ old('Legal', $progresPengurusanSuratTanah->Legal) }}" placeholder="Legal">
                                @error('Legal')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="NamaBank" id="NamaBank"
                                    ...
                                    @foreach ($bank as $b)
                                        <option value="{{ $b->id }}"
                                            {{ old('NamaBank', $progresPengurusanSuratTanah->NamaBank) == $b->id ? 'selected' : '' }}>
                                            {{ $b->Nama ?? '' }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="Keterangan" id="Keterangan" class="form-control @error('Keterangan') is-invalid @enderror"
                                    rows="3" placeholder="Keterangan">{{ old('Keterangan', $progresPengurusanSuratTanah->Keterangan) }}</textarea>
                                @error('Keterangan')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
